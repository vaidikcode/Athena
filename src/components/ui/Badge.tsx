...
const VARIANT_STYLES: Record<Variant, CSSProperties> = {
  agent: { background: "rgba(56,189,248,0.12)", color: "var(--agent)", border: "1px solid rgba(56,189,248,0.25)" },
  ...
  running: { background: "rgba(56,189,248,0.08)", color: "var(--status-running)", border: "1px solid rgba(56,189,248,0.2)" },
};
